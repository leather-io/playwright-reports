...
- Name: send stx: tests on testnet >> send form validation >> that the amount field enforces max length based on decimals
- Location: /home/runner/work/extension/extension/tests/specs/send/send-stx.spec.ts:132:5
