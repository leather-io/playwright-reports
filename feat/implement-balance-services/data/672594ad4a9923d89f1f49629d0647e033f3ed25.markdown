...
- Name: send stx: tests on testnet >> send form validation >> that the address must be valid
- Location: /home/runner/work/extension/extension/tests/specs/send/send-stx.spec.ts:147:5
...
Call log:
  - waiting for getByTestId('send-crypto-asset-btn')
    - locator resolved to <button type="button" data-testid="send-crypto-asset-btn" class="leather-pos_relative leather-textStyle_label.02 leather-ta_center leather-bdr_round leather-d_inline-flex leather-ai_center leather-jc_center leather-gap_space.02 leather-white-space_nowrap loading:after:leather-anim_spin loading:after:leather-bd_2px_solid loading:after:leather-bd-c_currentColor loading:after:leather-bd-b-c_transparent loading:after:leather-bx-s_border-box loading:after:leather-content_"" loading:after:leather-d_inline-b…>…</button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <html class="mode__full-page light">…</html> intercepts pointer events
    ...
    at /home/runner/work/extension/extension/tests/specs/send/send-stx.spec.ts:26:31
```
