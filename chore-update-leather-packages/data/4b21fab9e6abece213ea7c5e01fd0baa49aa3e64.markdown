...
index e44b94d7f..fb342af78 100644
--- a/package.json
+++ b/package.json
@@ -146,18 +146,18 @@
...
+    "@leather.io/analytics": "3.6.2",
+    "@leather.io/bitcoin": "0.26.8",
+    "@leather.io/constants": "0.21.0",
+    "@leather.io/crypto": "1.7.5",
+    "@leather.io/models": "0.34.0",
+    "@leather.io/provider": "1.2.20",
+    "@leather.io/query": "2.37.8",
+    "@leather.io/rpc": "2.16.5",
+    "@leather.io/stacks": "1.10.9",
+    "@leather.io/tokens": "0.18.0",
+    "@leather.io/ui": "1.68.6",
...
index 0b19816bd..0692e79b2 100644
--- a/pnpm-lock.yaml
+++ b/pnpm-lock.yaml
...
+        specifier: 2.37.8
+        version: 2.37.8(encoding@0.1.13)
       '@leather.io/rpc':
-        specifier: 2.10.3
...
+        specifier: 1.10.9
+        version: 1.10.9(encoding@0.1.13)
       '@leather.io/tokens':
-        specifier: 0.12.11
-        version: 0.12.11
+        specifier: 0.18.0
...
+        specifier: 1.68.6
+        version: 1.68.6(@babel/core@7.26.10)(@emotion/is-prop-valid@1.3.1)(@react-native-community/cli@18.0.0(typescript@5.4.5))(@types/react-dom@18.3.0)(@types/react@18.3.10)(@vue/compiler-sfc@3.5.16)(graphql@16.11.0)
       '@leather.io/utils':
-        specifier: 0.30.0
-        version: 0.30.0
+        specifier: 0.35.3
...
+        version: 2.0.5(vitest@3.1.4(@types/debug@4.1.12)(@types/node@20.12.12)(jiti@2.4.2)(jsdom@26.1.0)(lightningcss@1.30.1)(terser@5.40.0)(yaml@2.8.0))
       audit-ci:
         specifier: 6.6.1
         version: 6.6.1
...
+        version: 3.1.4(@types/debug@4.1.12)(@types/node@20.12.12)(jiti@2.4.2)(jsdom@26.1.0)(lightningcss@1.30.1)(terser@5.40.0)(yaml@2.8.0)
       vm-browserify:
         specifier: 1.1.2
         version: 1.1.2
...
+  '@leather.io/analytics@3.6.2':
+    resolution: {integrity: sha512-M/iGt+/4kInGHIjjoca9ixgE75sjkUGjRVSjgASo8kFvqWgF7q5uzr+Aybo8Ts2MN1wtWSodxO6fI2VreP1p3Q==}
...
+  '@leather.io/bitcoin@0.26.8':
+    resolution: {integrity: sha512-t83NZkjqOaDHg86nyVsTvcwJJUFrhjYdocWvQTgXVK3vnqe1ZpPzGkoMPZP3M7d7l74iNLpje+sB9pxSTZ3+KQ==}
...
+  '@leather.io/crypto@1.7.5':
+    resolution: {integrity: sha512-QvZCDrm0J8jk3QU9aYxGzW4FGWHXP3yBzSxV1RGvgC8kLRPta6FUlV/Xfs0AW3yBA21ezw+c6igRHSTw7QVXng==}
...
+  '@leather.io/query@2.37.8':
+    resolution: {integrity: sha512-JEqg/V1L8MJnsLUeoZ5fC+9QJWA22vVWWtka1SKp9Le4FDYI7DdZTHY6nzODqR4cJZodtfY+gT82EFBlb5oPkQ==}
...
+  '@leather.io/stacks@1.10.9':
+    resolution: {integrity: sha512-RFQVDDXpf7zGArZMyEys3R+OHXNli5a3rK3oqq8HqDPuzUUsCvBimtY73X3ZUFgnhxgYuZvnFg2n68JVF7rFhg==}
...
+  '@leather.io/ui@1.68.6':
+    resolution: {integrity: sha512-5L2v81uSNHX91kwTdJw4VgH9QzyJf5o3/3Lt4UlWab4JH7WppIZa8+1QPpfIrL/hJbcSFsm8TlVS+pl33NxY7Q==}
