...
index d937419e3..a63537d48 100644
...
+  PostConditionMode,
   ...
   noneCV,
   postConditionToWire,
@@ -66,6 +67,10 @@ function getTransactionOptionsFromRpcRequest(address: string) {
       : undefined,
     nonce: decodedRpcRequest.params.nonce,
     sponsored: decodedRpcRequest.params.sponsored,
+    postConditionMode:
...
index c9b6920ac..c23148807 100644
...
+  PostConditionMode,
   ...
   deserializeCV,
   postConditionToWire,
@@ -64,6 +65,10 @@ function getTransactionOptionsFromRpcRequest(address: string) {
       : undefined,
     nonce: decodedRpcRequest.params.nonce,
     sponsored: decodedRpcRequest.params.sponsored,
+    postConditionMode:
