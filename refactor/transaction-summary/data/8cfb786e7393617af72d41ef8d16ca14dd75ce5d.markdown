...
index 6d825bd15..81e3a3124 100644
...
index 47909e3ad..da43f6c24 100644
...
+import { StacksChainTxSummaryRoute } from '../sent-summary/stacks/stx-sent-summary.route';
...
+  );
+}
diff --git a/src/app/pages/send/sent-summary/stacks/stx-sent-summary.route.tsx b/src/app/pages/send/sent-summary/stacks/stx-sent-summary.route.tsx
new file mode 100644
index 000000000..0b3bb6db1
--- /dev/null
+++ b/src/app/pages/send/sent-summary/stacks/stx-sent-summary.route.tsx
@@ -0,0 +1,40 @@
...
+
+import { useLocationStateWithCache } from '@app/common/hooks/use-location-state';
+import { hexEncodedStacksTxSchema } from '@app/common/transactions/stacks/transaction.utils';
+import { RawTransactionLoader } from '@app/components/loaders/raw-tx-loader';
+
+import { StacksChainTxSummaryLoading } from './stacks-chain-tx-summary';
+import { Sip10SentSummary, StxSentSummary } from './stx-sent-summary';
+
...
+
+  if (!params || !hexEncodedStacksTxSchema.safeParse(tx).success)
