...
Expected: "0.00006 BTC"
Received: "0.00006 BTC"
    at /home/runner/work/extension/extension/tests/specs/send/send-btc.spec.ts:63:43
```
...
```ts
   ...
   62 |         .innerText();
>  63 |       test.expect(confirmationAssetValue).toEqual(`${amount} ${amountSymbol}`);
      |                                           ^ Error: expect(received).toEqual(expected) // deep equality
   64 |     });
   65 |
