...
index c2daaaaac..bbe138545 100644
--- a/package.json
+++ b/package.json
@@ -145,18 +145,18 @@
...
index 635befa01..a7f46bf7f 100644
--- a/pnpm-lock.yaml
+++ b/pnpm-lock.yaml
@@ -35,7 +35,7 @@ importers:
...
+        specifier: 2.36.4
+        version: 2.36.4(encoding@0.1.13)
       '@leather.io/rpc':
-        specifier: 2.10.3
...
+  '@leather.io/query@2.36.4':
+    resolution: {integrity: sha512-pwCurBEJrEGe6PxIXA/ORNah5OdVR88ZVRPYR2E8iFeRX6FuJbzX8+zZoOEINtLHb0wYPDwUfCxj9+EK9c/lww==}
