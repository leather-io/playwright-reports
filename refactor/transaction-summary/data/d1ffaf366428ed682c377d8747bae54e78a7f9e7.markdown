...
index 6d825bd15..62bdbc9a9 100644
...
+import { createMoney, isDefined, truncateMiddle } from '@leather.io/utils';
+
...
@@ -43,17 +55,17 @@ export const getTxCaption = (transaction: StacksTx) => {
     default:
       return null;
   }
-};
...
@@ -63,9 +75,9 @@ export const getTxValue = (tx: StacksTx, isOriginator: boolean): number | string
...
+export function getTxTitle(tx: StacksTx) {
   switch (tx.tx_type) {
     case 'token_transfer':
       return 'Stacks';
@@ -80,16 +92,16 @@ export const getTxTitle = (tx: StacksTx) => {
     default:
       return '';
   }
-};
...
@@ -127,3 +139,75 @@ export enum StacksTransactionActionType {
...
index 344488266..4ea89a5c5 100644
...
@@ -33,30 +31,10 @@ function safeAddressToString(address: string) {
   }
 }
 
-export function useStacksTransactionSummary(token: CryptoCurrency) {
+export function useStacksTransactionDetails(token: CryptoCurrency) {
...
@@ -97,7 +75,7 @@ export function useStacksTransactionSummary(token: CryptoCurrency) {
...
@@ -120,7 +98,11 @@ export function useStacksTransactionSummary(token: CryptoCurrency) {
 
     return {
       recipient: cvToString(payload.functionArgs[2]),
-      txValue: new BigNumber(txValue).shiftedBy(-decimals).toString(),
+      txValue: createMoney(
+        new BigNumber(txValue).shiftedBy(-decimals),
+        symbol.toUpperCase(),
+        decimals
+      ),
       ...
       fee: feeValue,
       totalSpend,
@@ -132,8 +114,5 @@ export function useStacksTransactionSummary(token: CryptoCurrency) {
     };
   }
...
index 3a6c3f0ba..7d7e27150 100644
...
@@ -16,7 +17,7 @@ interface SendFormConfirmationProps {
   fee?: string;
   totalSpend: string;
   symbol: string;
...
@@ -66,7 +67,7 @@ export function SendFormConfirmation({
         mt={['unset', 'space.05']}
         px="space.05"
         symbol={symbol}
...
index 636a3872b..d24e35c03 100644
...
@@ -10,7 +10,7 @@ import { useLocationStateWithCache } from '@app/common/hooks/use-location-state'
...
+import { useStacksTransactionDetails } from '@app/features/stacks-transaction-request/hooks/use-stacks-transaction-summary';
 import { BasicTooltip } from '@app/ui/components/tooltip/basic-tooltip';
 
 import { SendFormConfirmation } from '../send-form-confirmation';
@@ -30,12 +30,11 @@ export function StacksSendFormConfirmation() {
...
+  const { formReviewTxSummary } = useStacksTransactionDetails(
