...
index 78c9b5342..af3ae1eec 100644
...
@@ -30,15 +36,39 @@ export function useSignAndBroadcastStacksTransaction(method: RpcMethodNames) {
   return useCallback(
...
+      );
+
+      if (!signedTx) return logger.error('Error signing stacks transaction');
...
index c93863401..82bf58caf 100644
...
+        id: requestId,
+        error: { code: RpcErrorCode.INVALID_REQUEST, message: RpcErrorMessage.UnsignedTransaction },
+      })
+    );
+
