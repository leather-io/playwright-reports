...
index 101c2f911..7b13dd587 100644
...
@@ -26,7 +25,7 @@ function logInternalMessage(message: { method: string }) {
 }
...
@@ -44,7 +43,7 @@ export async function internalBackgroundMessageHandler(
       break;
   }
 
-  if (message.method.includes('bitcoinKeys/signOut')) {
+  if ('method' in message && message.method === 'bitcoinKeys/signOut') {
...
index 31436c254..3bc35bf62 100644
