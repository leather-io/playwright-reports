...
+import { formatDustUsdAmounts } from '@leather.io/utils';
 
+import { formatCurrency } from '@app/common/currency-formatter';
 import { BasicTooltip } from '@app/ui/components/tooltip/basic-tooltip';
 
 interface TransactionFeeProps {
@@ -23,8 +24,6 @@ export function TransactionFee({ fee, feeCurrencySymbol, usdAmount }: Transactio
   );
...
-      {feeLabel}
-    </BasicTooltip>
+    <BasicTooltip label={formatDustUsdAmounts(formatCurrency(usdAmount))}>{feeLabel}</BasicTooltip>
   );
 }
...
index e9ccb2e89..d09729817 100644
...
@@ -3,10 +3,11 @@ import { HStack } from 'leather-styles/jsx';
...
@@ -27,8 +28,8 @@ export function TransactionRecipientsLayout({
...
+    const captionRight = formatDustUsdAmounts(formatCurrency(fiatAmount));
...
index 7c1af6454..277fca90b 100644
...
@@ -2,8 +2,9 @@ import { Box, styled } from 'leather-styles/jsx';
...
@@ -33,13 +34,15 @@ export function SigningAccountCard({
...
+      <Caption>{formatDustUsdAmounts(formatCurrency(fiatBalance))}</Caption>
     </SkeletonLoader>
   );
