...
Call log:
  ...
  - attempting click action
    ...
    at /home/runner/work/extension/extension/tests/specs/transactions/transactions.spec.ts:33:63
```
...
index 65142b85b..60148a26e 100644
--- a/package.json
+++ b/package.json
@@ -146,18 +146,18 @@
...
+    "@leather.io/bitcoin": "0.26.3",
+    "@leather.io/constants": "0.20.2",
+    "@leather.io/crypto": "1.7.0",
+    "@leather.io/models": "0.32.1",
+    "@leather.io/provider": "1.2.15",
+    "@leather.io/query": "2.37.3",
+    "@leather.io/rpc": "2.16.0",
+    "@leather.io/stacks": "1.10.4",
+    "@leather.io/tokens": "0.18.0",
+    "@leather.io/ui": "1.68.0",
...
index cfd0c7403..a197e05b1 100644
--- a/pnpm-lock.yaml
+++ b/pnpm-lock.yaml
@@ -38,7 +38,7 @@ importers:
...
+        specifier: 1.2.15
+        version: 1.2.15(encoding@0.1.13)
       '@leather.io/query':
-        specifier: 2.35.1
-        version: 2.35.1(encoding@0.1.13)
+        specifier: 2.37.3
+        version: 2.37.3(encoding@0.1.13)
       '@leather.io/rpc':
-        specifier: 2.10.3
...
+        specifier: 1.68.0
+        version: 1.68.0(@babel/core@7.26.10)(@emotion/is-prop-valid@1.3.1)(@react-native-community/cli@18.0.0(typescript@5.4.5))(@types/react-dom@18.3.0)(@types/react@18.3.10)(@vue/compiler-sfc@3.5.14)(graphql@16.11.0)
       '@leather.io/utils':
-        specifier: 0.30.0
-        version: 0.30.0
+        specifier: 0.34.0
...
+        version: 0.10.0(eslint-config-prettier@10.1.5(eslint@8.56.0))(eslint-plugin-react-hooks@4.6.0(eslint@8.56.0))(eslint-plugin-react@7.34.1(eslint@8.56.0))(eslint@8.56.0)(globals@16.1.0)(typescript-eslint@8.32.1(eslint@8.56.0)(typescript@5.4.5))
+      '@leather.io/panda-preset':
+        specifier: 0.12.6
...
+        version: 2.0.5(vitest@2.0.5(@types/node@20.12.12)(jsdom@22.1.0)(lightningcss@1.30.1)(terser@5.39.2))
       audit-ci:
         specifier: 6.6.1
         version: 6.6.1
...
+        version: 2.0.5(@types/node@20.12.12)(jsdom@22.1.0)(lightningcss@1.30.1)(terser@5.39.2)
       vm-browserify:
         specifier: 1.1.2
         version: 1.1.2
       web-ext:
...
+  '@leather.io/bitcoin@0.26.3':
+    resolution: {integrity: sha512-UupaLVzCUH/8lu3B/kd2yn+sPWLLJaGm2r0pkwMoGCx1VKStGIr3M5+yKsi0gHqGDf7+iYGCYA0M74V3X08TFg==}
...
+  '@leather.io/constants@0.20.2':
+    resolution: {integrity: sha512-bFuoZ4Qita9a+insDW94qDhwGRNZloe1nAGak9pBtdjaGDbcKAJ/1Fwdoi7NOlsakIvUc4hh6WsI6Zf02FWQhg==}
 
-  '@leather.io/crypto@1.6.55':
-    resolution: {integrity: sha512-PXp8uWzjlqIqmfK2v351F1mKfxY38t//Eb/9+93egLzn5+qV5y3bYZNH8WDJ3wMqhXNJJbk1sMYrgHAtJFxeEg==}
+  '@leather.io/crypto@1.7.0':
+    resolution: {integrity: sha512-DirJm/G4xb8bkAp33//HKWLaxsRhQphaplpCJ6rngECw4o4rhysPl2o1tLYyFVYZChy418r0bH53/oagJ0bUgg==}
...
+  '@leather.io/provider@1.2.15':
+    resolution: {integrity: sha512-tE5NKNyxZ1ODaXTVfUFPhiRxSTY3tSZb+v9X23zK1kDLSSEGWH4wH7bMm5ZljCbTDO7aCGmohnbIDrGLuWTxPw==}
...
+  '@leather.io/query@2.37.3':
+    resolution: {integrity: sha512-TIIw9m5qH1gfoFu/8gDdLBEgji8YkpjjomBp/4O0ctw6BmE0lTehZRLZEY0EwjPlmxLr8/739LR8xWP91lE4YA==}
 
-  '@leather.io/tokens@0.12.11':
-    resolution: {integrity: sha512-/DF23QC8e5vIeVNQvagP5sMzSfgyZjvUW3XDo2FFRTM1T4YuCrPB8Gh03ElDMSp6CMLVStpsMROj7y7pU9eH7Q==}
+  '@leather.io/rpc@2.16.0':
+    resolution: {integrity: sha512-2jXd5JnPtXG9K/1GDCOo7oJgFDAvVZpHJtpP6aHJVvjslzeOC/JTtOvWl6If4/uHW/DjDLgaBQ1lNr/KOUHDEg==}
...
+  '@leather.io/stacks@1.10.4':
+    resolution: {integrity: sha512-Y3NWQ3ecpmBlFHmOLVXjYr4uzQqfCQGZVmDv9d3UZkJL8XVaVmj2zL6iaZPsxpacM+H22UXHBzQrEHXQ17dgsQ==}
...
+  '@leather.io/ui@1.68.0':
+    resolution: {integrity: sha512-Jw1egFqo/+bTiQfJkkEhai5Gxl9AWyWR80/GpOmuATo7GRyPgW2RRRyEn2rgNP2ZX6kReFoRpZ1Jabc0MKXXWQ==}
...
+  '@leather.io/utils@0.34.0':
+    resolution: {integrity: sha512-2FyGzA0StWln6pvjbTsRIyPYcs/rss4YDInKuplfcxv5spM4FaEOlRwLi+RPq0IvaS9meYFCjqA3+CwRvFh+Gg==}
