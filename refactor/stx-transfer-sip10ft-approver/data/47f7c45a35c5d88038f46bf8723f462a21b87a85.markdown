...
```diff
diff --git a/src/app/features/fee-editor/bitcoin/bitcoin-fees-loader.tsx b/src/app/features/fee-editor/bitcoin/bitcoin-fees-loader.tsx
index 1a7a57a2d..8a481fda3 100644
--- a/src/app/features/fee-editor/bitcoin/bitcoin-fees-loader.tsx
+++ b/src/app/features/fee-editor/bitcoin/bitcoin-fees-loader.tsx
@@ -1,5 +1,6 @@
...
index 6d81f777b..bbf767f23 100644
...
index 47772dc21..305c044ef 100644
--- a/src/app/pages/rpc-stx-call-contract/components/contract-call-details.layout.tsx
+++ b/src/app/features/rpc-transaction-request/stacks/contract-call-details.layout.tsx
@@ -12,10 +12,9 @@ import { AddressDisplayer, Approver } from '@leather.io/ui';
...
index b7906f33a..9e7ff2e0f 100644
...
index 9eee62b45..3c8d741e5 100644
...
index 48e312ee5..d70f93623 100644
...
+    <StxBalanceLoader address={account.address}>
       {(balance, isLoadingAdditionalData) => (
         <StacksNonceLoader>
           {nonce => (
@@ -43,7 +47,7 @@ export function RpcStxTransferStxContainer() {
               availableBalance={balance.availableBalance}
               marketData={stxMarketData}
...
+              txOptions={{ ...txOptionsForFeeEstimation, nonce }}
             >
               <NonceEditorProvider
                 nonce={nonce}
@@ -52,9 +56,11 @@ export function RpcStxTransferStxContainer() {
...
index 19dec7877..bdc3da9f5 100644
...
index fcd7ae55d..2b26ceb18 100644
...
index 309703791..1865ab591 100644
...
+  return principal.split('.')[0];
+}
diff --git a/tests/specs/rpc-stx-transfer-sip10-ft/rpc-stx-transfer-sip10-ft.spec.ts b/tests/specs/rpc-stx-transfer-sip10-ft/rpc-stx-transfer-sip10-ft.spec.ts
index fc10e1a66..4ca41ad66 100644
...
+        'text="You will transfer exactly0.001 LEO or the transaction will abort."'
+      );
+
