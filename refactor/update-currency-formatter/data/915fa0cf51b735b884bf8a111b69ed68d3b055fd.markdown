...
- Name: Compliance checks >> that it errors if non-compliant entity is detected
- Location: /home/runner/work/extension/extension/tests/specs/compliance-checks/compliance-checks.spec.ts:43:3
...
Locator: getByText('Unable to handle request, errorCode: 1398')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Unable to handle request, errorCode: 1398')

    at /home/runner/work/extension/extension/tests/specs/compliance-checks/compliance-checks.spec.ts:58:8
```
